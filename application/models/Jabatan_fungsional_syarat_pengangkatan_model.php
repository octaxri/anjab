...
class Jabatan_fungsional_syarat_pengangkatan_model extends CI_Model
{

    public $table = 'jabatan_fungsional_syarat_pengangkatan';
    public $id = 'id';
    public $order = 'ASC';
    ...
    function json() {
        ...
        $this->datatables->add_column('action', anchor(site_url('jabatan_fungsional_syarat_pengangkatan/update/$1'),'<i class="fa fa-pencil"></i>','class="btn btn-warning btn-xs"' )." ".anchor(site_url('jabatan_fungsional_syarat_pengangkatan/delete/$1'),'<i class="fa fa-trash"></i>','class="btn btn-danger btn-xs" onclick="javasciprt: return confirm(\'Apakah Anda Yakin Menghapus Data Ini ?\')"'), 'id');
