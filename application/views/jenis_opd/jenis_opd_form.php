      ...
      <div class="box">
        ...
        <div class="box-body">          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Jenis opd <?php echo $button ?></h3>
            </div>
	    ...
	    <div class="form-group col-md-6">
            <label for="varchar" class="control-label">Nama Jenis <?php echo form_error('nama_jenis') ?></label>
	    ...
	    <a href="<?php echo site_url('jenis_opd') ?>" class="btn btn-default">Cancel</a>
