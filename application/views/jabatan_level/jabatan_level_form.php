      ...
      <div class="box">
        ...
        <div class="box-body">          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">Jabatan level <?php echo $button ?></h3>
            </div>
	    ...
	    <div class="form-group col-md-6">
            <label for="varchar" class="control-label">Nama Level <?php echo form_error('nama_level') ?></label>
	    ...
	    <a href="<?php echo site_url('jabatan_level') ?>" class="btn btn-default">Cancel</a>
