      ...
      <div class="box">
        ...
        <div class="box-body">          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Mahasiswa <?php echo $button ?></h3>
            </div>
	    ...
	    <div class="form-group col-md-6">
            <label for="varchar" class="col-sm-2 control-label">Nim <?php echo form_error('nim') ?></label>
            <input type="text" class="form-control" name="nim" id="nim" placeholder="Nim" value="<?php echo $nim; ?>" />
        </div>
	    <div class="form-group col-md-6">
            <label for="varchar" class="col-sm-2 control-label">Nama <?php echo form_error('nama') ?></label>
            <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama" value="<?php echo $nama; ?>" />
        </div>
	    <div class="form-group col-md-6">
            <label for="varchar" class="col-sm-2 control-label">Jurusan <?php echo form_error('jurusan') ?></label>
