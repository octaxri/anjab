            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu" id="id_sid">
               ...
               <li><a href="<?php echo base_url(); ?>jabatan_kelompok"><i class="fa fa-circle-o text-red"></i> Kelompok Jabatan</a></li>
                ...
                <li><a href="<?php echo base_url(); ?>jabatan_kode_syarat_pengangkatan"><i class="fa fa-circle-o text-yellow"></i>Data KSP</a></li>
                <li><a href="<?php echo base_url(); ?>pangkatpendidikan"><i class="fa fa-circle-o text-yellow"></i>Data Pangkat Pendidikan</a></li>
                <li><a href="<?php echo base_url(); ?>jabatanlevelopd"><i class="fa fa-circle-o text-purple"></i>Data Jabatan Level OPD</a></li>
...
<!--Daftar OPD -->  
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu" id="id_sid">
                <li><a href="<?php echo base_url(); ?>jenisopd"><i class="fa fa-circle-o text-green"></i>Data Jenis OPD</a></li>
                <li><a href="<?php echo base_url(); ?>opd"><i class="fa fa-circle-o text-orange"></i>Data Daftar OPD</a></li>
                <li><a href="<?php echo base_url(); ?>jabatanopd"><i class="fa fa-circle-o text-purple"></i>Data Jabatan OPD</a></li>
