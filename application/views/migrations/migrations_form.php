    ...
    <section class="content">
      ...
      <div class="box">
	    ...
	    <div class="form-group col-md-6">
            <label for="varchar" class="control-label">Migration <?php echo form_error('migration') ?></label>
            <input type="text" class="form-control" name="migration" id="migration" placeholder="Migration" value="<?php echo $migration; ?>" />
        </div>
	    <div class="form-group col-md-6">
            <label for="int" class="control-label">Batch <?php echo form_error('batch') ?></label>
