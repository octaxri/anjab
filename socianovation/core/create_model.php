...
$string .="\n\n    // datatables
    function json() {
        ...
        \$this->datatables->add_column('action', anchor(site_url('".$c_url."/update/\$1'),'<i class=\"fa fa-pencil\"></i>','class=\"btn btn-warning btn-xs\"' ).\" \".anchor(site_url('".$c_url."/delete/\$1'),'<i class=\"fa fa-trash\"></i>','class=\"btn btn-danger btn-xs\" onclick=\"javasciprt: return confirm(\\'Apakah Anda Yakin Menghapus Data Ini ?\\')\"'), '$pk');
